...
ircs://user:pass@znc.server/@user1/@user2/@user3/#channel1
...
Vapid (WebPush)	vapid://	(TCP) 443	vapid://subscriber/target
...
Notification Service	Service ID	Default Port	Example Syntax
46elks	46elks://	(TCP) 443	46elks://user:password@FromPhoneNo
46elks://user:password@FromPhoneNo/ToPhoneNo
46elks://user:password@FromPhoneNo/ToPhoneNo1/ToPhoneNo2/ToPhoneNoN/
...
Clickatell	clickatell://	(TCP) 443	clickatell://ApiKey/ToPhoneNo
clickatell://FromPhoneNo@ApiKey/ToPhoneNo1/ToPhoneNo2/ToPhoneNoN
...
Seven	seven://	(TCP) 443	seven://ApiKey/FromPhoneNo
...
SMPP	smpp:// or smpps://	(TCP) 443	smpp://user:password@hostname:port/FromPhoneNo/ToPhoneNo
smpps://user:password@hostname:port/FromPhoneNo/ToPhoneNo1/ToPhoneNo2/ToPhoneNoN
...
Vonage (formerly Nexmo)	vonage://	(TCP) 443	vonage://ApiKey:ApiSecret@FromPhoneNo
